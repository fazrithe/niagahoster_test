...
<div class="section no-pad-bot" id="index-banner">
  ...
  <select class="browser-default" id="paket" onchange="tampilkan()" required>
    ...
    <option value="{{ $value->id }}" selected>{{ $value->price }}</option>
...
<div class="col s6">
    ...
    @endforeach
        ...
        <div class="col s7">
        <a href="{{ url('/chackout') }}"><i class="btn waves-effect waves-light">send</i></a>
        </div>
      @endif
    </div>
...
<div class="section no-pad-bot" id="index-banner">
  ...
  <h5>Pilih Domain</h5>
    ...
    <button class="btn waves-effect waves-light" type="submit" name="action">Add Cart
